...
RSpec.describe Post, type: :model do
    before(:all) do
        @user = User.new(name: 'John', photo: 'https://www.google.com/url', bio: 'I am a software developer', posts_counter: 3)
        @user.save
    end

    subject do
        Post.new(title: 'Hello', text: 'Hello world', author_id: @user.id, likes_counter: 6, comments_counter: 2, author_id: @user.id)
    end
    ...
    context 'Return valid post' do
        ...
        context 'Return invalid post' do
            ...
            it 'should not accept blank author_id' do
          ...
          it 'should not accept more than 250 character' do
            ...
            it 'should not accept blank non-integer likes counter' do
            ...
            it 'should not accept blank non-integer comments counter' do
